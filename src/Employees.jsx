...
const Employees = () => {
    ...
    const [ selectedTeam, setSelectedTeam ] = useState("TeamA"); // ["TeamA", "TeamB", "TeamC", "TeamD"
    ...
    const [employees, setEmployees] = useState([{
      ...
      function handleEmployeeCardClick(event){
        let employeeId = event.currentTarget.id;
        let employee = employees.find((employee) => employee.id === parseInt(employeeId));
